export default function NoteDeleteConfirmModal({ note, onCancel, onConfirm }) {
  return (
    <div
    ...
    >
      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          {/* Title */}
          <h2 className="mt-4 text-xl font-bold text-gray-900">Delete Note?</h2>

          {/* Note text in gray box */}
