    ...
    >
      ...
      >
              ...
              >
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="rounded-lg border border-gray-300 bg-white px-3 py-1.5 text-xs font-semibold text-gray-700 transition-colors hover:bg-gray-700 hover:text-white active:scale-[0.97]"
                  >
        ...
        <div className="shrink-0 border-t border-gray-200 px-6 py-4">
          ...
          <button
            onClick={onDismissAll}
            className="w-full rounded-lg bg-gray-100 px-4 py-2.5 text-sm font-semibold text-gray-700 transition-colors hover:bg-gray-700 hover:text-white active:scale-[0.97]"
          >
